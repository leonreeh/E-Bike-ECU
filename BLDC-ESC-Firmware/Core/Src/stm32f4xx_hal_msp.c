...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(ADC1_IN5_Throttle_GPIO_Port, ADC1_IN5_Throttle_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(GPIOC, ADC2_IN10_U_CUR_Pin|ADC2_IN11_V_CUR_Pin|ADC2_IN12_W_CUR_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA1     ------> ADC3_IN1
    */
    HAL_GPIO_DeInit(ADC3_IN13_TEMP_GPIO_Port, ADC3_IN13_TEMP_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC3_IN0_BUS_VOLT_Pin|ADC3_IN1_BUS_CUR_Pin);
